...
def generate_summary() -> str:
    ...
    # ── Header ────────────────────────────────────────────────────────────────
    W("## 🤖 Mehad Autonomous AI Test Agent")
    W("")
    ...
    W("")
    W("> *Tests generated by [Mehad Autonomous AI Test Agent](https://github.com/mejbaur-fagun/Mehad-Automation-Testing) — change any `.md` spec file and CI re-runs all tests automatically.*")
