...
def generate_summary() -> str:
    ...
    W("")
    W("> *Tests generated by [Autonomous AI Test Agent](https://github.com/rakibsanto/raad-ai-automation) — change any `.md` spec file and CI re-runs all tests automatically.*")
