...
def generate_summary() -> str:
    ...
    # ── Header ────────────────────────────────────────────────────────────────
    W("## 🤖 Markopolo Autonomous AI Test Agent")
    W("")
    ...
    W("")
    W("> *Tests generated by [Markopolo Autonomous AI Test Agent](https://github.com/mejbaur-markopolo/Markopolo-Automation-Testing) — change any `.md` spec file and CI re-runs all tests automatically.*")
