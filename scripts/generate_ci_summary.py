...
def generate_summary() -> str:
    ...
    # ── Header ────────────────────────────────────────────────────────────────
    W("## 🤖 Raad Autonomous AI Test Agent")
    W("")
    ...
    W("")
    W("> *Tests generated by [Raad Autonomous AI Test Agent](https://github.com/rakibsanto/raad-ai-automation) — change any `.md` spec file and CI re-runs all tests automatically.*")
