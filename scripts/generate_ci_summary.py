...
def generate_summary() -> str:
    ...
    # ── Header ────────────────────────────────────────────────────────────────
    W("## 🤖 Fagun Autonomous AI Test Agent")
    W("")
    ...
    W("")
    W("> *Tests generated by [Fagun Autonomous AI Test Agent](https://github.com/mejbaur-fagun/Fagun-Automation-Testing) — change any `.md` spec file and CI re-runs all tests automatically.*")
