...
# We prefer the-styled custom report (`agent-<src>.html`) generated by
...
def main() -> None:
    ...
    #    custom-styled `agent-<src>.html` over the default pytest-html
